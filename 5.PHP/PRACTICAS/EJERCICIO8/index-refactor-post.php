<?php
    ...
    if(isset($_POST['login'])){
        ...
        if($_POST['imgSaved']){
            unlink($_POST['imgSaved'] );
        }else if(isset($_POST['deleteAllImages'])){
        ...
        <ul class="nav justify-content-end">
            ...
            <li class="nav-item">
                ...
                <form action="" method="POST">
                    <input type="hidden" name="imgSaved" value="<?= $imgSaved; ?>" />
                    <button class="btn btn-outline-danger" type="Submit" name="logOut">Logout deleting this image</button>
                </form>
                <form action="" method="POST">
                    <input type="hidden" name="deleteAllImages" value="1" />
                    <button class="btn btn-outline-danger" type="Submit" name="logOut">Logout deleting all image</button>
                </form>
                <?php
                } 
                ?>
    ...
    <main>
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-6">
                    <?php
                    if(!isset($_POST['login']) || $validationResult['validate'] === false){
                    ?>
